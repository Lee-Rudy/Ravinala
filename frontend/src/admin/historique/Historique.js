...
import { cilMagnifyingGlass, cilCalendar, cilReload, cilBookmark, cilSearch, cilFilter, cilMenu } from '@coreui/icons';
...
const Historique = () => {
    ...
    // Fonction pour extraire les noms de cars uniques de la date sélectionnée
        ...
        <>
            ...
            <CNavbar color="light" light expand="md" className="mb-4">
                <CContainer fluid>
                    ...
                    <CNavbarToggler onClick={() => setIsFilterOpen(!isFilterOpen)} />
                    <CCollapse className="d-md-none" visible={isFilterOpen} onClick={() => setIsFilterOpen(false)}>
                        <CInputGroup className="mt-3">
                            ...
                            />
                            <CButton color="success" onClick={handleSearch}>
                ...
                <CRow>
                    ...
                    <CCol xs={12} md={4} lg={3} className="mb-4">
                        <CCard className="shadow-sm h-100">
                            ...
                            <CCardBody style={{ maxHeight: '55vh', overflowY: 'auto' }}>
                                {/* Barre de Recherche */}
                                ...
                                <div className="d-flex justify-content-between mb-4">
                                    <CButton
                                        ...
                                        style={{ borderRadius: '0.25rem' , backgroundColor: '#45B48E', color:'white' }}
                                    >
                                ...
                                <CCardBody>
                                    ...
                                    <CRow className="mb-4">
                                        <CCol md={4} className="mb-2">
                                            <CInputGroup>
                                                <CInputGroupText style={{ backgroundColor: '#45B48E', color: 'white' }}>
                                                        ...
                                                        {filteredData.imprévus
                                                            .map((item, index) => (
                                                                <CTableRow key={`${item.id}-${index}`}>
                                                                    ...
                                                                    <CTableDataCell>{item.nomVoiture}</CTableDataCell>
                                                                    <CTableDataCell>
                                                                        {new Date(`1970-01-01T${item.heureImprevu}Z`).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                                                    </CTableDataCell>
                                                                    <CTableDataCell>
