...
const Map_ramassage = () => {
    ...
    const fetchDirections = async (axeId) => {
        ...
        try {
            ...
            // Trier les points par heure_ramassage (ordre croissant)
            details = details.sort((a, b) => new Date(a.heure_ramassage) - new Date(b.heure_ramassage));
