            ...
            try
            {
                ...
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    foreach (var comptage in data)
                    {
                        ...
                        // Ajout les cellules d'en-tête avec la police en gras
